...
class Ui_ColorTransfer_Form(object):
    def setupUi(self, ColorTransfer_Form):
        ...
        ColorTransfer_Form.resize(210, 417)
        ...
        self.pushButton_7 = QtWidgets.QPushButton(ColorTransfer_Form)
        self.pushButton_7.setGeometry(QtCore.QRect(9, 66, 191, 51))
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(9, 295, 191, 51))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(9, 353, 191, 51))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, ColorTransfer_Form):
        ...
        self.pushButton_7.setText(_translate("ColorTransfer_Form", "Greyscale "))
